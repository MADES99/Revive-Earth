...
const KitConverted = () => {
  ...
  return (
        <div className='text-white flex lg:flex-row flex-col lg:gap-[45px] gap-[15px] lg:items-center items-start lg:mb-[32px] '>
            <h1 className='lg:text-[28px] font-[ClashDisplay-Variable]'>Some of the products we’ve converted:</h1>
            <div className='flex  gap-[44px]'>
                {
                    convertedProducts.map((item, i) => {
                        return  <div className='flex items-center gap-[7px]'>
                                    ...
                                    <h2 className='lg:text-[28px] font-medium font-[ClashDisplay-Variable]'>{item}</h2>
                                </div>
                    })
                }
