...
const ElectricVehicle = () => {
  return (
        <div className='relative md:my-[0] mt-[35px] mb-[168px]'>
            <img src={Map} alt="Map of Africa" />
            <div className='flex flex-col gap-[10px] items-center absolute lg:top-[164px] lg:left-[205px] top-[60px] left-[100px]'>
            ...
            <img src={MapVehicleMobile} alt="Map Vehicle Mobile" className='lg:hidden absolute bottom-[-120px] right-[6px]' />
        </div>
  )
}
