...
const NewsContent = () => {
  return (
            <p className=' text-[#050404] text-[14px] font-[inter] text-justify'>
                        <span className=''>‘Empowering the individual means empowering the nation. And empowerment is best served through rapid economic growth with rapid social change’</span>
                        <br />
                        <br />
            ...
            No wonder, over 200 of the world’s leading multinationals have found home in Israel, and those include, Google, Microsoft, Apple, Siemens, Facebook, Cisco, Lucent, Philips, AOL, Bershire-Hathaway, IBM , Toshiba and EMC to mention a few.
                        <br />
                        <br />
            In the words of renowned Austrian-American author, educator and management consultant, Peter Drucker, “We now accept that learning is a lifelong process of keeping abreast of change. And the most pressing task is to teach people how to learn.” It is apparent that a good number of highly focused Nigeria youths have started embracing Science and Technology as critical subjects that can advance their careers in no small measure. But they still need a lot to learn for many years to come, especially from the copious experience of countries in the mold of the State of Israel in matters bordering on Innovation, Engineering, Science and Technology and who are eager to assist.And it is in this sense that the collaboration between the Israeli Embassy in Nigeria, and Innov8 Hub should be lauded by all, as it sets on course to contributing largely to the social economic transformation of Nigeria.
              </p>
  )
}
