...
import MobileNews from '../assets/MobileNews.png'
import NewsContent from './NewsContent'
import NewsSocial from './NewsSocial'

const NewsHeader = () => {
  return (
    <div className='m-0 pt-[60px] px-[23px] pb-[41px] lg:py-[56px] lg:px-[80px] bg-black  md:bg-white'>
        ...
        <div>
            <div>
              <img src={MobileNews} alt="News Image" className='md:hidden'/>
            </div>
            ...
            <div>
              <img src={DesktopNews} alt="News Image" className='hidden md:flex w-full mt-[22px] mb-[38px]'/>
            </div>
            ...
            <div className='flex flex-col gap-[20px]'>
              ...
              <div className='flex flex-col gap-[20px]'>
                ...
                <p className='flex md:flex-row flex-col md:items-center i gap-[15px] md:text-[#0F0B0B] text-[white] text-[14px] leading-[19px]'> 
                  Nigeria 
