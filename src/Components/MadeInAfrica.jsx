...
const MadeInAfrica = () => {
  return (
    <div className='m-0 africa flex justify-center '>
            <div className='flex md:flex-row  md:gap-[44px] items-center flex-col md:mt-[145px] md:mb-[144px] mt-[60px] mb-[101px] mx-[23px] md:mx-[0]'>
                <h1 className='md:hidden text-[64px] font-medium font-[ClashDisplay-Variable] text-[#EDEDED] leading-[64px]'>AFRICAN MADE</h1>

                <ElectricVehicle />

                <div className='py-[43px] px-[36px] bg-[#1C290F] flex flex-col gap-[16px] text-[#E7E7E7] max-w-[589px]'>
                    <h2 className='md:text-[32px] text-[24px] font-medium leading-[38px] md:leading-[32px]  font-[ClashDisplay-Variable]'>Electric Vehicles made for Africa, in Africa, by Africans.</h2>
