  ...
  return (
    <div className='flex gap-[16px]'>
              <div className='flex flex-col gap-[8px]'>
                <div className='py-[12px] pl-[16px] pr-[14px] bg-white lg:bg-[#0F0B0B] flex items-center gap-[8px] rounded-[5px]'>
                  ...
                  <input type="text" placeholder='Enter your email' className='lg:placeholder-white  placeholder-black leading-6 text-[16px] font-[inter]'/>
                </div>

                <p className='text-[14px] text-white lg:text-black font-[inter] leading-[20px] font-normal'>We care about your data in our <span className=''>privacy policy</span></p>
              </div>
